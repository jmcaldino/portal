package com.gestion.calmar.webapp.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "calmar@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "calmar API";

        private String description = "calmar API documentation";
